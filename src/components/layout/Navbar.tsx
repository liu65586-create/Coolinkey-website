...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-[100] h-[80px] border-b border-[rgba(255,255,255,0.1)] bg-[#0a0a0b]">
      <div className="mx-auto flex h-full max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-3 md:hidden">
          ...
          <button
            type="button"
            className="inline-flex h-11 w-11 items-center justify-center rounded-md border border-[rgba(255,255,255,0.15)] text-white hover:text-[#00e676]"
            aria-expanded={open}
      ...
      {open ? (
        <div id="mobile-nav" className="border-b border-[rgba(255,255,255,0.1)] bg-[#0a0a0b] md:hidden">
