...
export function ManualCard({ manual, onOpen }: Props) {
  ...
  return (
    <button
      ...
      className="group w-full rounded-[12px] bg-[#111111] p-6 text-center shadow-[0_0_0_1px_rgba(255,255,255,0.06)] transition-shadow hover:shadow-[0_0_0_1px_#00e676,0_12px_40px_rgba(0,0,0,0.45)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#00e676]"
    >
